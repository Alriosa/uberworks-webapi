// =====================================================================================
// FILE SUMMARY
// What it does: Defines the 7 possible roles a user can have in the system. C# doesn't
...
//               closed list of valid options the compiler knows and validates. Manager,
//               Company, and Support were appended at the END on purpose, never inserted
//               between existing values: System.Text.Json serializes enums as plain integers
//               by default, and uberworks-webapp keeps its own copy of this exact enum
//               (Models/ApiContracts/UserRole.cs) — reordering existing members would
//               silently misread every Role value already flowing between the two projects.
...
/// Manager/Company/Support/Professional/Client. Manager creates Company/Professional/Client.
...
/// Company, Support, Professional, and Client accounts.
...
/// Support: internal staff who handle disputes/reports (Dashboard/Support.cshtml) — created
/// only by Admin/MasterAdmin, never self-registered, never able to create other accounts.
/// </summary>
